...
/**
 * It calculates the new events generated by the user (while typing)
 * Basically it is the difference between 2 LighthouseFiles
 * */
public class LighthouseDelta {
	...
	/**
	 * This method exist only for test propose
	 * We use this because we need a way to populate a delta from a xml file
	 * */
