...
public class VisualSummaryView extends Panel{
	...
	//	this.add(textLabel, new Rectangle(0,0,50,50));
		...
		this.add(createStatGrid("threads",total));
		this.add(createStatGrid("answers",answered));
		this.add(createStatGrid("responses",responses));
		
	}
	
	public Panel createStatGrid(String name, int number){
