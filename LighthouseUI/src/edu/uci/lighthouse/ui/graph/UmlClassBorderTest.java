...
public class UmlClassBorderTest extends AbstractBorder{

	private Color color;

	public UmlClassBorderTest(){
		
	}
	
	public UmlClassBorderTest(Color color){
		setColor(color);
	}
	...
	public void paint(IFigure figure, Graphics graphics, Insets insets) {
		if (figure instanceof UmlClassFigureTest){
			// Get bounds
			...
			UmlClassFigureTest classFigure = (UmlClassFigureTest) figure;
